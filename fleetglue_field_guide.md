...
_An in-depth breakdown you can drop into Substack_
...
One cell works (evidence, not vibes).

Paste the spec-line across projects.

Integrators must use us (default control layer).
